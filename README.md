...
| Platform | Download |
|----------|----------|
| Linux (Ubuntu 20.04+) | [ethminer-limonata-linux.tar.gz](https://github.com/Limonata-Blockchain/limonata-ethminer/releases/latest) |
| Windows | Coming soon |
...
1. **Setup your delegate key** at [pool.limonata.xyz/setup.html](https://pool.limonata.xyz/setup.html)
...
🍋 **Limonata - Fresh Blocks, Squeezed Daily** 🍋
